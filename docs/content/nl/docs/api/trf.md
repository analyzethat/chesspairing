...
Het `trf`-pakket (`github.com/analyzethat/chesspairing/trf`) verzorgt het lezen, schrijven, valideren en converteren van FIDE Tournament Report Files. Het ondersteunt zowel TRF16 (legacy) als TRF-2026.
