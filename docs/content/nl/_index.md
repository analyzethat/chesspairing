...
<div class="mx-auto">
  ...
  <a class="btn btn-lg btn-secondary me-3 mb-4" href="https://github.com/analyzethat/chesspairing">
    GitHub
  </a>
...
`go get github.com/analyzethat/chesspairing` en deel programmatisch in. Geen afhankelijkheden, veilig voor gelijktijdig gebruik.
{{% /blocks/feature %}}
