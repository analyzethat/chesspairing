...
The `trf` package (`github.com/analyzethat/chesspairing/trf`) handles reading, writing, validating, and converting FIDE Tournament Report Files. It supports both TRF16 (legacy) and TRF-2026 formats.
